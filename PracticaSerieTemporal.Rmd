...
close <- Dataset[,c(5)]
close.ts = ts(close, start = 1, frequency = 365)
...
Como vemos no es estacionaria ya que el pvalue no es menor a 0.1 y también se puede observar como los datos se salen de los límites de las gráficas mostradas. Primeramente probaremos a realizar una diferencia para ver si conseguimos convertirla en estacionaria.
